...
!function (a) {
    ...
    if (!a.jstree) {
        ...
        m.className = "jstree-icon jstree-checkbox", m.setAttribute("role", "presentation"), a.jstree.defaults.checkbox = {
            ...
            this.bind = function () {
                c.bind.call(this), this._data.checkbox.uto = !1, this._data.checkbox.selected = [], this.settings.checkbox.three_state && (this.settings.checkbox.cascade = "undetermined"), this.element.on("init.jstree", a.proxy(function () {
