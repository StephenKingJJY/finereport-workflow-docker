   ...
   var groupValueIndex = 1;
    ...
    $scope.save = function() {//猜测 $scope.assignment是子页面值， $scope.property.value.assignment是保存后显示的值
		...
		//自定义
			var group_arr=[];
			var group_temp={};
			group_temp["value"]=document.getElementById("userField").value;
			group_arr.push(group_temp)
			$scope.assignment.assignee=document.getElementById("assigneeField").value;
			$scope.assignment.candidateUsers=group_arr;
        //end
        $scope.property.value.assignment= $scope.assignment;
